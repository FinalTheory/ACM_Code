/*
	高精度运算问题，递推貌似有点复杂，直接copy了别人的思路。
	见wiki：http://en.wikipedia.org/wiki/Dividing_a_circle_into_areas
	另外原本的运算库确实有BUG，修改了一处。
	为了让g++能编译通过真心折腾死我了！！！
*/
#include <iostream>
#include <cstdio>
...
#endif
	int T, i;
	BigInteger A, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6;
	cin >> T;
	for ( i = 1; i <= T; i++ )
	{
		cin >> A;
